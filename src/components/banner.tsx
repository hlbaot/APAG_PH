...
export default function Banner() {
  ...
  return (
    <div className="relative w-full bg-white overflow-hidden select-none border-b border-gray-100 min-h-[90px] sm:min-h-[110px] md:min-h-[130px] lg:min-h-[145px] flex items-center justify-center">
      ...
      <div className="relative z-10 w-full max-w-[1360px] 2xl:max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-center py-2 sm:py-3">
        <Link href="/" aria-label="Trang chủ APAG" className="block relative w-full group">
          <Image
            ...
            height={323}
            priority
            className="w-full h-auto max-h-[85px] sm:max-h-[110px] md:max-h-[130px] lg:max-h-[145px] object-contain mx-auto block group-hover:opacity-95 transition-opacity"
          />
        </Link>
      </div>
    </div>
