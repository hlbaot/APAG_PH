...
export default function Footer() {
  ...
  return (
    <footer className="w-full mt-auto text-white font-sans">
      {/* Top Red Bar */}
      <div className="bg-[#b31f24] py-2.5 px-4 overflow-x-auto">
        <div className="mx-auto flex items-center justify-center gap-x-6 text-xs md:text-sm font-bold uppercase tracking-wide whitespace-nowrap w-fit">
      ...
      <div className="relative bg-[#213063] text-slate-100 pt-7 pb-10 px-4 sm:px-6 lg:px-8 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          {/* Dùng flex thay vì grid để nội dung co lại tự nhiên theo chiều rộng container */}
          <div className="flex flex-col md:flex-row gap-6 md:gap-8 items-start">
            ...
            <div className="min-w-0 flex-1 text-xs sm:text-[13px] leading-relaxed space-y-2">
            ...
            <div className="min-w-0 flex-1 text-xs sm:text-[13px] leading-relaxed space-y-3.5">
