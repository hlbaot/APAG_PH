...
import "@/scss/hop-tac-quoc-te/lien-he/lien-he.scss";
...
export default function LienHeHtqtPage() {
        ...
        <div className="flex flex-row max-[480px]:flex-col gap-6 xl:gap-7 items-start">
          ...
          <main className="flex-1 min-w-0">
            ...
            <div className="py-16 sm:py-24 text-center">
              <p className="text-[13.5px] sm:text-[14px] text-gray-600 font-normal">
                Không có dữ liệu
              </p>
            </div>

            {/* Tìm kiếm thông tin */}
            <div className="mt-8 pt-4 flex flex-col sm:flex-row items-center justify-start gap-3 pl-1 sm:pl-2">
