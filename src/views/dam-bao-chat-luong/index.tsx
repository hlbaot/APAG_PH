...
import "@/scss/dam-bao-chat-luong/dam-bao-chat-luong.scss";

// ─── APAG Logo Card Component ───────────────────────────────────────────────
const ApagLogoCard = ({ className = "", large = false }: { className?: string; large?: boolean }) => (
  <div
...
// ─── Dữ liệu Trang 1 (Ảnh 1) ────────────────────────────────────────────────
const page1Data: PageData = {
  featured: {
    id: "p1-feat",
    title: "Bế mạc đợt khảo sát chính thức đánh giá ngoài cơ sở giáo dục tại Học viện Hành chính và Quản trị công",
  ...
  grid: [
    {
      id: "p1-g1",
      title: "Khai mạc Khảo sát chính thức đánh giá ngoài cơ sở giáo dục tại Học viện Hành chính và Quản trị công",
    ...
    {
      id: "p1-g2",
      title: "Đoàn đánh giá ngoài cơ sở giáo dục tiến hành khảo sát chính thức và làm việc tại 3 phân hiệu của Học viện Hành chính và Quản trị công",
    ...
    {
      id: "p1-g3",
      title: "Học viện Hành chính và Quản trị công công khai Dự thảo Báo cáo Tự đánh giá cơ sở giáo dục để lấy ý kiến góp ý",
      isLogoCard: true,
      href: "/dam-bao-chat-luong/dbcl-co-so-giao-duc",
    },
  ],
  list: [
    {
      id: "p1-l1",
      title: "Giấy chứng nhận kiểm định chất lượng chương trình đào tạo trình độ đại học đối với 08 ngành của Học viện Hành chính và Quản trị công",
    ...
    {
      id: "p1-l2",
      title: "Quyết định về việc thành lập Tổ Đảm bảo chất lượng giáo dục tại các đơn vị thuộc, trực thuộc Học viện Hành chính và Quản trị công",
    ...
    {
      id: "p1-l3",
      title: "Quyết định về việc thành lập Hội đồng Đảm bảo chất lượng giáo dục của Học viện Hành chính và Quản trị công",
    ...
    {
      id: "p1-l5",
      title: "Kế hoạch Tổ chức lớp tập huấn Nâng cao năng lực đảm bảo chất lượng cơ sở giáo dục đại học đáp ứng tiêu chuẩn đánh giá chất lượng của Bộ Giáo dục và Đào tạo",
...
// ─── Dữ liệu Trang 2 (Ảnh 2) ────────────────────────────────────────────────
const page2Data: PageData = {
  featured: {
    id: "p2-feat",
    title: "Quyết định Ban hành Quy định về so chuẩn, đối sánh chất lượng giáo dục của Học viện Hành chính và Quản trị công",
  ...
  grid: [
    {
      id: "p2-g1",
      title: "Bế mạc đợt khảo sát chính thức đánh giá chất lượng 08 chương trình đào tạo đại học tại Học viện Hành chính và Quản trị công",
    ...
    {
      id: "p2-g2",
      title: "Khai mạc đợt khảo sát chính thức đánh giá chất lượng 08 chương trình đào tạo đại học tại Học viện Hành chính và Quản trị công",
    ...
    {
      id: "p2-g3",
      title: "Chính thức khảo sát đánh giá ngoài 08 chương trình đào tạo của Học viện Hành chính và Quản trị công",
  ...
  list: [
    {
      id: "p2-l1",
      title: "Hội nghị Khảo sát sơ bộ đánh giá ngoài 08 chương trình đào tạo trình độ đại học tại Học viện Hành chính và Quản trị công",
    ...
    {
      id: "p2-l5",
      title: "Kế hoạch số 426/KH-HCQG về việc khảo sát lấy ý kiến phản hồi từ các bên liên quan về các lĩnh vực hoạt động của Học viện Hành chính Quốc gia năm 2024",
    ...
    {
      id: "p2-l6",
      title: "Quyết định về việc ban hành chính sách đảm bảo chất lượng giáo dục của Học viện Hành chính Quốc gia",
...
const page3Data: PageData = {
  ...
  grid: [
    {
      id: "p3-g1",
      title: "Quyết định về việc ban hành Quy định hoạt động đảm bảo chất lượng giáo dục đại học của Học viện Hành chính Quốc gia",
      isLogoCard: true,
      href: "/dam-bao-chat-luong/he-thong-van-ban-phap-luat",
    },
    {
      id: "p3-g2",
      title: "Kế hoạch Đảm bảo chất lượng giáo dục năm 2023",
      isLogoCard: true,
      href: "/dam-bao-chat-luong/he-thong-van-ban-phap-luat",
    },
    {
      id: "p3-g3",
      title: "Quyết định Thành lập Hội đồng Đảm bảo chất lượng giáo dục của Học viện Hành chính Quốc gia",
      isLogoCard: true,
      href: "/dam-bao-chat-luong/he-thong-van-ban-phap-luat",
    },
  ],
  list: [
    {
      id: "p3-l1",
      title: "Quyết định Thành lập Tổ Đảm bảo chất lượng giáo dục tại các đơn vị thuộc, trực thuộc Học viện Hành chính Quốc gia",
      date: "18:00 06/07/2023",
      isLogoCard: true,
      href: "/dam-bao-chat-luong/he-thong-van-ban-phap-luat",
    },
    {
...
export default function DamBaoChatLuongPage() {
    ...
    <div className="w-full bg-white min-h-screen py-6 sm:py-8 font-sans">
      <div className="w-full max-w-[1240px] xl:max-w-[1280px] mx-auto px-3 sm:px-4">
        <div className="flex flex-row max-[480px]:flex-col gap-6 xl:gap-7 items-start">
          {/* ══════════════════════════════════════════════════════════════════
              CỘT TRÁI (SIDEBAR) — Chiều rộng cố định (~280-300px)
              ══════════════════════════════════════════════════════════════════ */}
          ...
          <main className="flex-1 min-w-0">
            ...
            <article className="flex flex-row max-[480px]:flex-col gap-4 sm:gap-5 items-start">
              <div className="w-[48%] max-[480px]:w-full shrink-0">
                <Link
                  ...
                  className="block relative w-full h-[210px] sm:h-[240px] md:h-[235px] overflow-hidden group cursor-pointer"
                >
            ...
            {/* 2. Hàng 3 bài kế tiếp (Lưới 3 cột) */}
            <div className="grid grid-cols-3 max-[480px]:grid-cols-1 gap-4 sm:gap-5 mt-6 pt-5 border-t border-gray-200">
              {currentContent.grid.map((article) => (
                <article key={article.id} className="flex flex-col">
                  ...
                  <h3 className="text-[clamp(13px,0.75rem+0.15vw,14.5px)] font-bold text-gray-900 hover:text-[#DA251C] transition-colors leading-snug mt-2.5 line-clamp-3">
            ...
            {/* 3. Các bài còn lại (Dạng danh sách dọc, ảnh/logo trái - chữ phải) */}
              ...
              <div className="space-y-5 sm:space-y-6 mt-6 pt-5 border-t border-gray-200">
                {currentContent.list.map((article) => (
                  ...
                  >
                    ...
                    {/* Cột chữ: tiêu đề + ngày giờ + mô tả nếu có */}
                    <div className="flex-1 min-w-0">
                      <h3 className="text-[clamp(13px,0.78rem+0.18vw,15px)] font-bold text-gray-900 hover:text-[#DA251C] transition-colors leading-snug">
                        <Link href={article.href}>{article.title}</Link>
                      </h3>
            ...
            {/* 5. Khung Tìm Kiếm Thông Tin (như ở ảnh 3) */}
            <div className="mt-8 flex justify-center items-center">
              <div className="flex items-center border border-gray-300 rounded px-3 py-1.5 max-w-sm w-full bg-white shadow-xs focus-within:border-gray-400">
                <input
                  type="text"
