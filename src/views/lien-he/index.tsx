...
export default function LienHePage() {
  ...
  const handleRequestOtp = async () => {
    ...
    try {
      // Xử lý gửi OTP mô phỏng tại client (web tĩnh)
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      // Giả lập gửi form thành công ở client
  ...
  return (
    <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="flex flex-col">
          <div className="flex items-center justify-between mb-3">
            ...
            <a
              href="https://www.google.com/maps/search/?api=1&query=749+Tr%E1%BA%A7n+H%C6%B0ng+%C4%90%E1%BA%A1o%2C+%C4%90i%E1%BB%87n+Ng%E1%BB%8Dc%2C+%C4%90i%E1%BB%87n+B%C3%A0n"
              target="_blank"
              rel="noopener noreferrer"
              className="text-xs text-[#DA251C] hover:underline flex items-center gap-1 font-semibold"
            >
          ...
          <iframe
            title="Bản đồ Phân hiệu Học viện Hành chính và Quản trị công"
            src="https://www.google.com/maps/embed?origin=mfe&pb=!1m3!2m1!1zNzQ5IFRy4bqnbiBIxrBuZyDEkOG6oW8sIMSQaeG7h24gTmfhu41jLCDEkGnhu4duIELDoG4sIFF14bqjbmcgTmFt!6i16!3m1!1svi!5m1!1svi"
          ...
          <p className="text-xs text-gray-500 mt-2 italic">
            * Vị trí: Số 749 đường Trần Hưng Đạo, Điện Bàn (khu vực giáp ranh TP. Đà Nẵng)
          </p>
        </div>
      ...
      <div className="mt-10 pt-8 border-t border-gray-200">
        <h2 className="text-2xl font-bold text-[#1E2A5E] mb-5">
          Phân hiệu Học viện Hành chính và Quản trị công tại TP. Đà Nẵng
        </h2>

        <ul className="space-y-4">
          <li className="flex items-start gap-3">
            <MapPin className="w-5 h-5 text-[#DA251C] mt-0.5 flex-shrink-0" />
            <span className="text-gray-700 text-sm">
              <span className="font-medium">Địa chỉ:</span> Số 749 đường Trần Hưng Đạo, phường Điện Bàn Đông, TP. Đà Nẵng
            </span>
          </li>
          <li className="flex items-start gap-3">
            <Phone className="w-5 h-5 text-[#DA251C] mt-0.5 flex-shrink-0" />
            <span className="text-gray-700 text-sm">
              <span className="font-medium">Điện thoại / Hotline:</span> (0236) 3843 223
              {" "}—{" "}
              <span className="font-medium">Fax:</span> (0236) 3843 224
            </span>
          </li>
          <li className="flex items-start gap-3">
            <Mail className="w-5 h-5 text-[#DA251C] mt-0.5 flex-shrink-0" />
            <span className="text-gray-700 text-sm">
              <span className="font-medium">Email:</span>{" "}
              <a
                href="mailto:phanheudanang@apag.edu.vn"
                className="text-[#1E2A5E] font-medium hover:underline hover:text-[#DA251C]"
              >
                phanheudanang@apag.edu.vn
              </a>
              {" "}(hoặc{" "}
              <a
                href="mailto:apag@apag.edu.vn"
          ...
          <li className="flex items-start gap-3">
            <Globe className="w-5 h-5 text-[#DA251C] mt-0.5 flex-shrink-0" />
            <span className="text-gray-700 text-sm">
